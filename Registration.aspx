        ...
        <tr>
           ...
           <td>
               ...
               <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                   ErrorMessage="Minimum Password length must be 6 characters" ControlToValidate="txtPassword"
                   ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ValidationExpression="^[a-zA-Z0-9'@&#.\s][6,15]$"></asp:RegularExpressionValidator>
               </div>
           </td>
       </tr>
        <tr>
           ...
           <td>
               ...
               <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                   ErrorMessage="Minimum Password length must be 6 characters" ControlToValidate="txtConfirmPassword"
                   ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ValidationExpression="^[a-zA-Z0-9'@&#.\s][6,15]$"></asp:RegularExpressionValidator>
        ...
        <tr>
           ...
           <td>
               ...
               <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                   ...
                   ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
               </div>
           </td>
       </tr>
        <tr>
